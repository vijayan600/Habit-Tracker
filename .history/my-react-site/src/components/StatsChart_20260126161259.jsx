        ...
        <div className="line-chart-wrapper">
          ...
          >
            ...
            {points.map((point, index) => {
              ...
              return (
                <g key={`point-${index}`} style={{ pointerEvents: 'all' }}>
                  ...
                  <circle
                    ...
                    onMouseOver={(e) => {
                      e.stopPropagation();
                      console.log('Mouse over point', index);
                      setHoveredPoint(index);
                    }}
                    onMouseOut={(e) => {
                      e.stopPropagation();
                      console.log('Mouse out point', index);
                      setHoveredPoint(null);
                    }}
                    onClick={(e) => {
                      e.stopPropagation();
                      console.log('Click point', index);
                      setHoveredPoint(isHovered ? null : index);
                    }}
                  />
