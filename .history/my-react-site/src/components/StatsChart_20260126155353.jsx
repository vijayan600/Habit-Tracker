...
export default function StatsChart({ habits, currentYear, currentMonth }) {
  ...
  const handlePointEnter = (index, event) => {
    ...
    // Get the actual mouse/touch position
  ...
  const handlePointMove = (index, event) => {
      ...
      <div className="chart-container">
        ...
        <div className="line-chart-wrapper">
          ...
          >
            ...
            {points.map((point, index) => (
              <circle
                ...
                onMouseMove={(e) => handlePointMove(index, e)}
                onMouseLeave={handlePointLeave}
                onTouchStart={(e) => {
                  e.preventDefault();
                  handlePointEnter(index, e);
                }}
                onTouchMove={(e) => handlePointMove(index, e)}
          ...
          {hoveredPoint !== null && points[hoveredPoint] && (
            ...
            >
              <div style={{ fontWeight: '700', color: '#10b981', marginBottom: '6px', fontSize: '0.9rem' }}>
                Day {points[hoveredPoint].day}
              </div>
              <div style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '4px', color: '#e5e5e5' }}>
