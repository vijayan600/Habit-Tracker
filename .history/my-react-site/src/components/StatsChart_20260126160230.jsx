...
export default function StatsChart({ habits, currentYear, currentMonth }) {
  ...
  const showTooltip = (event, pointData) => {
    console.log('showTooltip called', pointData); // Debug log
    
    if (!wrapperRef.current) {
      console.log('wrapperRef not found'); // Debug log
      return;
    }
    ...
    console.log('Tooltip position:', { x, y }); // Debug log
  ...
  // Hide tooltip
  const hideTooltip = () => {
    console.log('hideTooltip called'); // Debug log
