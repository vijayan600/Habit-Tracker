...
export default function StatsChart({ habits, currentYear, currentMonth }) {
  ...
  console.log('Current hoveredPoint:', hoveredPoint); // Debug log
      ...
      <div className="chart-container">
        ...
        <div className="line-chart-wrapper">
          ...
          >
            ...
            {/* Data points with larger invisible hover areas */}
            ...
            {/* Single SVG Tooltip - rendered ONCE, with pointer-events: none */}
            {hoveredPoint !== null && points[hoveredPoint] && (
              <g style={{ pointerEvents: 'none' }}>
                {(() => {
                  ...
                  const flipVertical = point.y < 100;
                  const flipLeft = point.x < 100;
                  const flipRight = point.x > chartWidth - 150;
                  
                  let tooltipX = point.x - tooltipWidth / 2;
                  let tooltipY = flipVertical ? point.y + 20 : point.y - tooltipHeight - 20;
                  
                  if (flipLeft) tooltipX = point.x + 20;
                  if (flipRight) tooltipX = point.x - tooltipWidth - 20;
                  ...
                  return (
                    <>
                      ...
                      {!flipVertical && (
                        <polygon
                          points={`${tooltipX + tooltipWidth / 2},${tooltipY + tooltipHeight} ${tooltipX + tooltipWidth / 2 - 8},${tooltipY + tooltipHeight + 8} ${tooltipX + tooltipWidth / 2 + 8},${tooltipY + tooltipHeight + 8}`}
                          fill="#10b981"
                          style={{ pointerEvents: 'none' }}
                        />
                      )}
                      {flipVertical && (
                        <polygon
                          points={`${tooltipX + tooltipWidth / 2},${tooltipY} ${tooltipX + tooltipWidth / 2 - 8},${tooltipY - 8} ${tooltipX + tooltipWidth / 2 + 8},${tooltipY - 8}`}
                          fill="#10b981"
                          style={{ pointerEvents: 'none' }}
                        />
                      )}
